...
- **Unit flags on the map** — an optional setting draws each unit's logic flag in red above it; the default flag 0 stays hidden. Display only: saves and multiplayer are unaffected.
